...
export const mockHotel: Hotel = {
  ...
  description: {
    ...
    content: [
      "Занимая исторический особняк 18-го века в самом сердце 1-го округа, L'Atelier de la Paix — это больше, чем отель, это роскошь и великолепие. Каждый люкс был специально отреставрирован известными мастерами, сочетая оригинальные черты неоклассицизма с авангардным современным искусством.",
